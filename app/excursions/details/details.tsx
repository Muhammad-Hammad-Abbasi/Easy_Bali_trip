  ...
  return (
    <main className="font-medium">
      ...
      <div className="flex justify-center">
        <div className="max-w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 py-5 px-4 font-medium text-[#3f3f3f]">
          ...
          <div className="relative w-[300px] md:w-[350px] lg:w-[420px] overflow-hidden group bg-slate-50">
            ...
            <Link href="">
              ...
              <div className="p-4">
                <h2 className="font-bold text-2xl py-3 text-[#000000]">Ubud Tour</h2>
                <p className="mt-3">
          ...
          <div className="relative w-[300px] md:w-[350px] lg:w-[420px] overflow-hidden group bg-slate-50">
            <Link href="">
              ...
              <div className="p-4">
                <h2 className="font-bold text-2xl py-3 text-[#000000]">North Bali Tour</h2>
                <p className="mt-3">
          ...
          <div className="relative w-[300px] md:w-[350px] lg:w-[420px] overflow-hidden group bg-slate-50">
            <Link href="">
              ...
              <div className="p-4">
                <h2 className="font-bold text-2xl py-3 text-[#000000]">East Bali Tour</h2>
                <p className="mt-3">
            ...
            <Link href="">
              ...
              <div className="p-4">
                <h2 className="font-bold text-2xl py-3 text-[#000000]">South Bali Tour</h2>
                <p className="mt-3">
            ...
            <Link href="">
              ...
              <div className="p-4">
                <h2 className="font-bold text-2xl py-3 text-[#000000]">Private Tour To Ubud</h2>
                <p className="mt-3">
            ...
            <Link href="">
              ...
              <div className="p-4">
                <h2 className="font-bold text-2xl py-3 text-[#000000]">West Nusa penida Tour </h2>
                <p className="mt-3">
     ...
     <h2 className="flex justify-center pt-10">
        <Link href={"/excursions"}>
        
           <button className="bg-black text-white py-2 px-6 rounded-sm text-sm font-medium hover:bg-slate-200 hover:text-black">VIEW ALL EXCURSIONS</button>
